...
export const BUY_EXACT_IN_DISCRIMINATOR = new Uint8Array([
  250, 234, 13, 123, 213, 156, 19, 236,
]);

export function getBuyExactInDiscriminatorBytes() {
...
> = {
  ...
  minimumAmountOut: BuyExactInInstructionDataArgs['minimumAmountOut'];
  shareFeeRate: BuyExactInInstructionDataArgs['shareFeeRate'];
};
